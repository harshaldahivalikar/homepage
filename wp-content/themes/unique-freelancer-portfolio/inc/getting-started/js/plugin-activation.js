jQuery(document).ready(function($) {
    'use strict';
    var this_obj = unique_freelancer_portfolio_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.unique-freelancer-portfolio-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message unique-freelancer-portfolio-plugin-install');
                button.addClass('button-primary unique-freelancer-portfolio-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.unique-freelancer-portfolio-recommended-plugins .unique-freelancer-portfolio-activation-note').css('display','block');
    ...
    $(document).on('click', '.unique-freelancer-portfolio-plugin-activate', function(event) {
