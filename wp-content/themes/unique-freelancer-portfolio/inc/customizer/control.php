 ...
 */
class Unique_Freelancer_Portfolio_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-freelancer-portfolio' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-freelancer-portfolio-customize-controls' );
		wp_enqueue_script( 'unique-freelancer-portfolio-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Freelancer_Portfolio_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
