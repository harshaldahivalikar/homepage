 ...
 * @since 1.0.0
 */
class Unique_Freelancer_Portfolio_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'unique_freelancer_portfolio';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'unique-freelancer-portfolio' ), $i ),
...
// Initialize.
$Unique_Freelancer_Portfolio_Footer_Widgets = new Unique_Freelancer_Portfolio_Footer_Widgets();